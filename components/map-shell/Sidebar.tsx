...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const annotationPalette = useMemo<AnnotationItem[]>(
    () => [
      ...
      { key: "bore-2", label: '2" Bore', inches: 2, color: "#FF5126" },
      { key: "bore-2.5", label: '2.5" Bore', inches: 2.5, color: "#FF5126" },
      { key: "bore-3", label: '3" Bore', inches: 3, color: "#FF5126" },
      { key: "bore-4", label: '4" Bore', inches: 4, color: "#FF5126" },
      { key: "bore-5", label: '5" Bore', inches: 5, color: "#FF5126" },
      { key: "bore-6", label: '6" Bore', inches: 6, color: "#FF5126" },
      { key: "bore-8", label: '8" Bore', inches: 8, color: "#FF5126" },
      { key: "bore-10", label: '10" Bore', inches: 10, color: "#FF5126" },
      { key: "bore-12", label: '12" Bore', inches: 12, color: "#FF5126" },
      { key: "bore-16", label: '16" Bore', inches: 16, color: "#FF5126" },
