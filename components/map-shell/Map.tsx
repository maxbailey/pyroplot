        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm text-white/70">
            ...
            <p>
              ...
              However, fireworks regulations vary by state, county, city, and
              site conditions. You must always confirm requirements with, and
              obtain approval from, your local Authority Having Jurisdiction
              (AHJ) before conducting any fireworks display. Local laws,
              site-specific geography, and weather conditions may override or
